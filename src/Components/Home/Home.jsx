		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						I am a Full Stack Developer based in Alwar. I love to build
						things for web.
					</h1>
					<div className={styles.btn}>
						<a
							href='https://drive.google.com/drive/folders/11VbPHKSgrO375modE1JuVRB0XLjPrFXK?usp=sharing'
							target='_blank'
						>
							<Button
								text={
				...
				>
					<img
						...
						src='https://i.imgur.com/KUd4QCN.jpeg'
						alt='Profile pic'
					/>
				</div>
			</div>
