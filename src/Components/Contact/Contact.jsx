		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto: mynikhil1999@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/ASHarslan'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/nikhil-gupta-026762167/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Nikhil Gupta, 2021 All rights
				reserved.
			</div>
		</footer>
	);
